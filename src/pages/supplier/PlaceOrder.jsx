...
const PlaceOrder = () => {
  ...
  return (
    <div>
      ...
      <div className="card-box" style={{ maxWidth: 700 }}>
        ...
        <div className="section-title">Add Item to Order</div>
        <div
          style={{
            display: "flex",
            gap: 10,
        ...
        {notFound && (
          <div className="alert-ims alert-warning">⚠ Product not found.</div>
        )}
        {foundProduct && (
          <div className="alert-ims alert-info" style={{ marginBottom: 0 }}>
            📦 <strong>{foundProduct.name}</strong> —{" "}
            {foundProduct.price.toLocaleString()} VND
          </div>
        )}
      </div>
      ...
      {orderItems.length > 0 && (
        <div
          className="card-box"
          style={{ padding: 0, overflow: "hidden", marginTop: 0 }}
        >
          <div className="table-toolbar">
            <span className="table-toolbar-title">Order Items</span>
                ...
                <tr key={i.productId}>
                  ...
                  <td>
                    <button
                      ...
                      onClick={() =>
                        setOrderItems(
                          orderItems.filter((x) => x.productId !== i.productId),
                        )
                      }
                    >
                      Remove
          ...
          <div style={{ padding: "16px 20px", display: "flex", gap: 10 }}>
            <button className="btn-primary-ims" onClick={handlePlaceOrderClick}>
              🛒 Place Order
            </button>
